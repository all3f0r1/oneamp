...
mod tests {
    ...
    fn test_skin_discovery_and_loading() {
        ...
        for skin in &skin_manager.available_skins {
            assert!(
                !skin.metadata.name.is_empty(),
                "Skin name should not be empty"
            );
            assert!(
                !skin.metadata.author.is_empty(),
                "Skin author should not be empty"
            );
            assert!(
                !skin.metadata.version.is_empty(),
                "Skin version should not be empty"
            );
        }
    }
    ...
    fn test_get_active_skin() {
        ...
        assert_eq!(
            ...
            skin_manager.available_skins[skin_manager.active_skin_index]
                .metadata
                .name,
