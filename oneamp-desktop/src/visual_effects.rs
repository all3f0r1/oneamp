...
impl VisualEffects {
    ...
    pub fn drop_shadow(
        ...
        for i in 0..steps {
            ...
            let shadow_rect = rect.translate(offset).expand(expansion);
    ...
    pub fn metallic_panel(
        ...
        let top_third =
            Rect::from_min_max(rect.min, Pos2::new(rect.max.x, rect.min.y + height / 3.0));
        ...
        painter.rect_stroke(
            rect,
            rounding,
            Stroke::new(1.0, base_color.linear_multiply(0.5)),
        );
    }
